        ...
        <div className="auth-page">
            <div className="auth-container">
                <div className="card">
                    ...
                    {errors.length > 0 && (
                        <div className="mb-6 p-4 rounded-xl border bg-red-50 text-red-700 border-red-200">
                            {errors.length === 1 && errors[0].includes('confirmou o seu e-mail') ? (
                                <div className="flex gap-2 items-start">
                                    <svg className="w-5 h-5 flex-shrink-0 text-red-600 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                    </svg>
                                    <div>
                                        <strong>Conta Restrita.</strong><br />
                                        {errors[0]}
                                    </div>
                                </div>
                            ) : (
