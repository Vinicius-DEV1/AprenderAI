...
(async () => {
    try {
        ...
        await page.waitForSelector('h3', { timeout: 10000 }).catch(() => console.log('Selector timeout but continuing...'));
        await new Promise(resolve => setTimeout(resolve, 3000)); // give it an extra 3s to render
