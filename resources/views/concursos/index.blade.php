                        ...
                        @if($concurso->link_oficial)
                            <div class="mt-auto pt-2 border-t border-slate-100 dark:border-slate-700">
                                <a href="{{ $concurso->link_oficial }}" target="_blank" rel="noopener noreferrer"
                                    class="flex items-center justify-center gap-1.5 w-full text-xs font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition-colors py-1">
