                ...
                <div class="p-6 bg-white border-b border-slate-200">
                    <div x-data="{
                        ...
                        <form x-ref="form" action="{{ route('study-plan.store') }}" method="POST"
                            ...
                            <!-- Step 1: Availability -->
                            <div class="mb-8">
                                <h3 class="text-lg font-medium leading-6 text-slate-900 mb-4">Disponibilidade</h3>
                                ...
                                <select id="hours_per_day" name="hours_per_day" x-model="hours"
                                    class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-slate-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                                    @for ($i = 1; $i <= 10; $i++)
                            ...
                            <!-- Step 2: Goal -->
                            <div class="mb-8">
                                <h3 class="text-lg font-medium leading-6 text-slate-900 mb-4">Objetivo Principal</h3>
                                ...
                                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                                    ...
                                    <div x-show="examType === 'concurso'" style="display: none;">
                                        ...
                                        <input type="text" name="exam_name" id="exam_name"
                                            class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-slate-300 rounded-md"
                            ...
                            <!-- Step 3: Date -->
                            <div class="mb-8">
                                <h3 class="text-lg font-medium leading-6 text-slate-900 mb-4">Data da Prova (Opcional)
                                </h3>
                                <div class="max-w-xs">
