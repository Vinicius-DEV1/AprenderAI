<x-layouts.admin>
    ...
    <form action="{{ route('admin.integrations.update') }}" method="POST">
            ...
            <div class="p-6 border-b border-gray-100 bg-gray-50 flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Permitir que usuários façam login com suas contas do Google.</p>
                    </div>
                </div>
        ...
        <div class="flex justify-end">
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 px-6 rounded-lg transition-colors shadow-sm">
