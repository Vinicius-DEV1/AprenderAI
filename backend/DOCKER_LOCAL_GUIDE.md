...
Este guia descreve como rodar o projeto **AprenderAI** localmente de forma totalmente automatizada, sem depender do Sail.
...
- **Acessar o terminal do app:** `docker exec -it aprender-ai-app bash`
