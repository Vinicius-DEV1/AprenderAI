        ...
        $mockAiService->shouldReceive('evaluateEssay')
            ...
            ->andReturn([
                ...
                'response' => [
                    ...
                    'checklist' => [],
                    'corrections' => [],
                    'improved_version' => 'Esta é uma versão melhorada do texto original, com tamanho suficiente para passar pelo filtro de tamanho mínimo (pelo menos duzentos caracteres para ignorar o fallback, e mil e duzentos para o ENEM. Entao repetindo: Esta é uma versão melhorada do texto original, com tamanho suficiente para passar pelo filtro de tamanho mínimo. repetindo: Esta é uma versão melhorada do texto original, com tamanho suficiente para passar pelo filtro de tamanho mínimo. repetindo: Esta é uma versão melhorada do texto original, com tamanho suficiente para passar pelo filtro de tamanho mínimo. repetindo: Esta é uma versão melhorada do texto original, com tamanho suficiente para passar pelo filtro de tamanho mínimo. repetindo: Esta é uma versão melhorada do texto original, com tamanho suficiente para passar pelo filtro de tamanho mínimo. repetindo: Esta é uma versão melhorada do texto original, com tamanho suficiente para passar pelo filtro de tamanho mínimo. repetindo: Esta é uma versão melhorada do texto original, com tamanho suficiente para passar pelo filtro de tamanho mínimo. repetindo: Esta é uma versão melhorada do texto original, com tamanho suficiente para passar pelo filtro de tamanho mínimo. repetindo: Esta é uma versão melhorada do texto original, com tamanho suficiente para passar pelo filtro de tamanho mínimo. repetindo: Esta é uma versão melhorada do texto original, com tamanho suficiente para passar pelo filtro de tamanho mínimo. repetindo: Esta é uma versão melhorada do texto original, com tamanho suficiente para passar pelo filtro de tamanho mínimo.)',
                    'competencies' => [
                        ['name' => 'C1', 'score' => 160],
                        ['name' => 'C2', 'score' => 200],
                        ['name' => 'C3', 'score' => 160],
