    ...
    Route::middleware(['is.admin'])->prefix('admin')->name('admin.')->group(
        function () {
            ...
            Route::prefix('analytics')->name('analytics.')->group(function () {
                ...
                Route::get('/behavior', [\App\Http\Controllers\Admin\AnalyticsController::class, 'behavior'])->name('behavior');
                Route::get('/acquisition', [\App\Http\Controllers\Admin\AnalyticsController::class, 'acquisition'])->name('acquisition');
                Route::get('/conversion', [\App\Http\Controllers\Admin\AnalyticsController::class, 'conversion'])->name('conversion');
                Route::get('/monetization', [\App\Http\Controllers\Admin\AnalyticsController::class, 'monetization'])->name('monetization');
                Route::get('/realtime', [\App\Http\Controllers\Admin\AnalyticsController::class, 'realtime'])->name('realtime');
                Route::get('/realtime-data', [\App\Http\Controllers\Admin\AnalyticsController::class, 'realtimeData'])->name('realtime-data');
                Route::get('/alerts', [\App\Http\Controllers\Admin\AnalyticsController::class, 'alerts'])->name('alerts');
            });
            ...
            Route::prefix('questions-batch')->name('questions.batch.')->group(
                function () {
            ...
            // ----------------------------------------------------------------
            Route::prefix('enem-import')->name('enem-import.')->group(
                function () {
